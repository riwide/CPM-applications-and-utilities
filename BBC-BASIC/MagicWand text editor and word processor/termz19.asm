...
***********************************************
**	       T E R M I N A L		     		     3220 LOUISIANA, SUITE 205
*		     HOUSTON, TEXAS  77006
*		     (713)528-5158
*
*	LAST REVISION 6/5/81 by Magnolia Mi**
***********************************************
*		 Zenith z19 VERSION
...
TERMDIM DB	ROWSURSOR LOCATION
ROW	DB	1
COL	DB	1
CONOUT	DB	0,0,0	;CONOUT ADDR TO BE SUPPLIED AT INITIALIZATION
ZPRSEQ	JMP	PRSEQ	;OUTPUT CHARX,COLSX	;PHYSICAL TERMINAL LIMITS
SCRDIM	EQU	$		;CURRENT SCREEN LIMITS
ROWS	DB	ROWSX-1
COLS	DB	COLSX
CURSOR	EQU	$	;CURRENT C SEQUENCE AT DE UNTIL NULL
...
ZALARM	JMP	ALARM	L ID NUMBER FOR SERIAL
*
*********CONTROL TABLES
*
CTAB	DB	8,16,24,32,40,48,56,64,72,COLSX,0,0,0,0,0,0
	DB	255	;TAB TABLE S;SOUND ALARM BELL, IF ANY
ZINIT	JMP	INITSCRN ;INITIALIZE TERMINAL, IF NEEDED
ZNAME	DB	'H19/z19         '
ZID	DB	'HX'	;TERMINATOP BYTE
*
...
XDELTC	DB	128+'N'	;*DC* XDUPE	DB	128+'Q' ;'Red'	REPEAT SEARCH/REPLACE
XFIND	DB	128+'P' ;'Blue' START SEARCH/REPLACE
XSETMK	DB	128+'R' ;'Gray' SET BLOC CHARACTER DELETE
...
*
BLKMARK EQU	1	;BLOCK MARKE7	;BELL CODE
...
SSET BLOCK-CURSOR
	...
	DB	0	;SEQUENCEETCCOD EQU	'Y'	;SET CURSOR LOC CODE
XCLEAR	EQU	'E'	;SCREEN CLEAR CODE
LCLEAR	EQU	'K'	;LINE CLEAR CODE
INTSEQ	DB	LEADIN,'x4' ; TERMINATOR
...
LNSEQ	DB	LEADIN	;SEQUENCE TO CLEAR LINE
	DB	LCLEAR
	DB	0
SETSEQ	DB	LEADIN	;SEQUENCE TO SET CURSOR LOCAT;FIRST SET CURSOR
...
SCROLSQ DB	LEADIN	;SEQUENCE TO SCROLL FWD 1 LINE
	DB	SETCCOD 54,32	;TO LAST WINDOW ROW
	DB	LEADIN	;AND
	DB	LCLEAR	;CLEAR IT
	DB	0
*
...
PRSEQ	LDAX	D	;PRINT SEQ AT DE UNTIL ZERO
	...
	LHLD	6
	LXI	D,-6
	DAINITSCRN EQU	$	;INIT/DE-INIT ENVIRONMENT
	LXI	D,EXITSEQ
	LXI	H,INITSW
	MOV	A,M
	MVI	M,-1
...
NOINIT:
	LDW	0	;ADDRESS FOR CBIOS CHAR STATUS
